...
LOAD TABLE "netflow"."netflow" FROM ('/netflow/netflow_1.csv.gz') EXTERNAL LOCATION "netflow"."netflow_location" EXTERNAL FORMAT "netflow"."netflow_format" WITH (max_bad_rows '100');
