...
aws s3 ls 's3://gdelt-open-data/v2/mentions/' --no-sign-request >v2-mentions.listing
...
curl https://gdelt-open-data.s3.amazonaws.com/v2/mentions/20150218230000.mentions.csv >./v2-20150218230000.mentions.csv
